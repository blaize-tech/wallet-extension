...
describe('Confirm Transaction utils', () => {
  ...
  describe('getValueFromWeiHex', () => {
    it('should get the transaction amount in AC', () => {
      const ethTransactionAmount = utils.getValueFromWeiHex({
        value: '0xde0b6b3a7640000', toCurrency: 'AC', conversionRate: 468.58, numberOfDecimals: 6,
      })
  ...
  describe('getTransactionFee', () => {
    it('should get the transaction fee in AC', () => {
      const ethTransactionFee = utils.getTransactionFee({
        value: '0x1319718a5000', toCurrency: 'AC', conversionRate: 468.58, numberOfDecimals: 6,
      })
