...
describe('send selectors', () => {
  ...
  describe('getSelectedToken()', () => {
    ...
    it('should return the send token if none is currently selected, but a send token exists', () => {
      ...
      const editedMockState = {
        affilcoin: Object.assign({}, mockState.affilcoin, {
  ...
  describe('getSelectedTokenContract()', () => {
    ...
    it('should return null if no token is selected', () => {
      const modifiedAffilcoinState = Object.assign({}, mockState.affilcoin, { selectedTokenAddress: false })
      assert.equal(
        getSelectedTokenContract(Object.assign({}, mockState, { affilcoin: modifiedAffilcoinState })),
        null
      )
    })
  })
  ...
  describe('transactionsSelector()', () => {
    ...
    it('should return all transactions if no token is selected', () => {
      const modifiedAffilcoinState = Object.assign({}, mockState.affilcoin, { selectedTokenAddress: false })
      const modifiedState = Object.assign({}, mockState, { affilcoin: modifiedAffilcoinState })
      assert.deepEqual(
    ...
    it('should return shapeshift transactions if current network is 1', () => {
      const modifiedAffilcoinState = Object.assign({}, mockState.affilcoin, { selectedTokenAddress: false, network: '1' })
      const modifiedState = Object.assign({}, mockState, { affilcoin: modifiedAffilcoinState })
      assert.deepEqual(
        transactionsSelector(modifiedState),
        [
