 ...
 * gets converted into a decimal value depending on the currency (AC or Fiat).
 */
export default class CurrencyInput extends PureComponent {
  ...
  getDecimalValue (props) {
    ...
    const decimalValueString = this.shouldUseFiat()
      ...
      : getValueFromWeiHex({
        value: hexValue, toCurrency: AC, numberOfDecimals: 6,
      })
  ...
  handleChange = decimalValue => {
    ...
    const hexValue = this.shouldUseFiat()
      ...
      : getWeiHexFromDecimalValue({
        value: decimalValue, fromCurrency: AC, fromDenomination: AC, conversionRate,
      })
