...
describe('Personal Message Manager', function () {
  ...
  describe('#addMsg', function () {
    it('adds a Msg returned in getMsgList', function () {
      var Msg = { id: 1, status: 'approved', affilcoinNetworkId: 'unit test' }
  ...
  describe('#setMsgStatusApproved', function () {
    it('sets the Msg status to approved', function () {
      var Msg = { id: 1, status: 'unapproved', affilcoinNetworkId: 'unit test' }
      messageManager.addMsg(Msg)
  ...
  describe('#_updateMsg', function () {
    it('replaces the Msg with the same id', function () {
      messageManager.addMsg({ id: '1', status: 'unapproved', affilcoinNetworkId: 'unit test' })
      messageManager.addMsg({ id: '2', status: 'approved', affilcoinNetworkId: 'unit test' })
      messageManager._updateMsg({ id: '1', status: 'blah', hash: 'foo', affilcoinNetworkId: 'unit test' })
