...
describe('config view actions', function () {
  ...
  describe('SET_RPC_TARGET', function () {
    it('sets the state.affilcoin.rpcTarget property of the state to the action.value', function () {
      const action = {
      ...
      assert.equal(result.affilcoin.provider.type, 'rpc')
      assert.equal(result.affilcoin.provider.rpcTarget, 'foo')
    })
  })
})
