...
* Load older version of Affilcoin and attempt to simulate updating the extension.
...
* Token Management
    ...
    * Send that token to another affilcoin address.
...
* Ganache set blocktime to simulate retryTx in Affilcoin
